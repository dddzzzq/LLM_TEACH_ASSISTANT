...
class AIGCDetectorService:
    ...
    def __init__(self):
        ...
        # --- 定义两个模型 ---
        self.prose_model_name = r"/root/autodl-tmp/dzq/ai_grading_assistant/models/chatgpt-detector-roberta-chinese" # 用于文字报告
        self.code_model_name = r"/root/autodl-tmp/dzq/ai_grading_assistant/models/chatgpt-detector-roberta"       # 用于源代码
